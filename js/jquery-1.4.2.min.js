...
(function(A,w)
	{function ma()
		{if(!c.isReady)
			...
			catch(a){setTimeout(ma,1);return}
			c.ready()}}
			function Qa(a,b)
			...
			function X(a,b,d,f,e,j)
			{
				...
				if(typeof b==="object")
                  ...
                  {d[0].type=a;
                  	...
                  	function oa(a)
                  	{var b,d=[],f=[],e=arguments,j,i,o,k,n,r;i=c.data(this,"events");
                  	...
                  	for(r=j.length;n<r;n++)
                  		for(k=0;k<u.length;k++)
                  			{i=u[k];if(j[n].selector===i.selector)
                  				{o=j[n].elem;f=null;if(i.preType==="mouseenter"||i.preType==="mouseleave")
                  				f=c(a.relatedTarget).closest(i.selector)[0];
                  				if(!f||f!==o)d.push({elem:o,handleObj:i})}}
                  					n=0;
                  				for(r=d.length;n<r;n++)
                  					{j=d[n];a.currentTarget=j.elem;a.data=j.handleObj.data;a.handleObj=j.handleObj;
                  							...
                  							b.each(function()
                  								{if(this.nodeName===(a[d]&&a[d].nodeName))
                  									{var f=c.data(a[d++]),e=c.data(this,f);
                  										if(f=f&&f.events){delete e.handle;e.events={};
                  										for(var j in f)for(var i in f[j])c.event.add(this,j,f[j][i],f[j][i].data)}}})}
                  							function sa(a,b,d)
                  							{
                  								var f,e,j;b=b&&b[0]?b[0].ownerDocument||b[0]:s;
                    if(a.length===1&&typeof a[0]==="string"&&a[0].length<512&&b===s&&!ta.test(a[0])&&(c.support.checkClone||!ua.test(a[0])))
                    	{
                    		...
                    		if(j=c.fragments[a[0]])if(j!==1)f=j}
                    			...
                    			function K(a,b)
                    			{
                    				var d={};c.each(va.concat.apply([],va.slice(0,b)),
                    				function()
                    				{d[this]=a});
                    				return d}
                    				function wa(a)
                					...
                					if(d[1])
                						{
                					        ...
                					        if(a=Xa.exec(a))
                					        	if(c.isPlainObject(b))
                					        		...
                					        		else{if(b=s.getElementById(d[2])){if(b.id!==d[2])
                					        			return T.find(a);
                					        		...
                					        		if(a.selector!==w)
                					        			{
                					        				...
                					        				return c.makeArray(a,this)},selector:"",jquery:"1.4.2",length:0,size:
                					        				function()
                					        				{
                					        					return this.length
                					        				},
                					        				toArray:function()
                					        				{return R.call(this,0)},get:function(a)
                					        				{return a==null?this.toArray():a<0?this.slice(a)[0]:this[a]},
                					        				pushStack:function(a,b,d)
                					        				{var f=c();c.isArray(a)?ba.apply(f,a):c.merge(f,a);
                					        					f.prevObject=this;
                					        				...
                					        				{return c.each(this,a,b)},ready:function(a)
                					        				{
                					        					c.bindReady();
                					        					if(c.isReady)
                					        						a.call(s,c);
                					        					...
                					        					return this},eq:function(a)
                					        					{
                					        							...
                					        							return this.eq(0)},last:function()
                					        						{
                                                                           ...
                                                                           function(b,d)
                                                                        {
                					        							    ...
                					        							    function()
                					        							    {
                	return this.prevObject||c(null)},push:ba,sort:[].sort,splice:[].splice};
                	        									...
                	        									if(Q)
                	        										{
                	        											for(var a,b=0;a=Q[b++];)
                	        												a.call(s,c);
                	        											Q=null}c.fn.triggerHandler&&c(s).triggerHandler("ready")}},
                	        											bindReady:function()
                	        											{
                	        												if(!xa)
                	        													{
                	        														xa=true;
                	        														if(s.readyState==="complete")return c.ready();if(s.addEventListener){s.addEventListener("DOMContentLoaded",
